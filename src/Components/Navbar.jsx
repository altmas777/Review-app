...
const Navbar = ({switchTheme,theme}) => {
  return (
    <>
     ...
     <nav className='h-20  w-full shadow-lg  flex justify-between items-center px-8 bg-gray-100'>
        <h1 className='font-bold text-2xl text-white bg-gradient-to-r from-orange-500 to-yellow-400 px-4 py-2 rounded-lg shadow-md'>
          REVIEW APP
        </h1>

        
        <label className="inline-flex items-center relative">
  <input  onChange={switchTheme} // 👈 THIS is the key part
            checked={!theme} // 👈 Keeps UI synced with state 
